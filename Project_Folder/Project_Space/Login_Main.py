...
class Ui_Concentrate_Advance(object):
    ...
    def setupUi(self, Concentrate_Advance):
        ...
        self.Save_change_button_Plate_Info.setGeometry(QtCore.QRect(80, 490, 180, 30))
        self.Save_change_button_Plate_Info.setMinimumSize(QtCore.QSize(150, 30))
        ...
        self.Availability_button.setObjectName("Fail_type_button_2")
